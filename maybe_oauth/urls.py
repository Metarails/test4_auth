...
urlpatterns = [
    ...
    path(
        "o/",
        include(
            (oauth2_endpoint_views, "oauth2_provider_2"), namespace="oauth2_provider_2"
        ),
    ),
    path("api/hello/", ApiEndpointTest1_view.as_view()),  # an example resource endpoint
    path("api/hello2/", ApiEndpointTest2_view.as_view()),
]
